...
def eye_lid_close() -> MotorCommandBuilder:
    """ Close eye lids.

    :param seconds: the time in seconds for the animation to run for.
    :return: the close eye lids command.
    """
    print(type(MotorId.eyelids))
    return motor(MotorId.eyelids, 1, 0.1)
...
'''def move_robot(y) -> MotorCommandBuilder:
    """ Move Robot to the desired position
...
def moves_robot() -> MotorCommandBuilder:
    """ Move Robot to the desired position
